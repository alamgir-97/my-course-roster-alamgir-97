...
const Course = ({course, onClick}) => {
    ...
    return (
        <div className='bg-white  rounded-3xl w-80'>
            ...
            <img src={img} alt="" className='w-full mb-2'></img>
            ...
            <button className='text-lg font-semibold rounded-md bg-blue-700 w-full text-white py-2' onClick={onClick}>Select</button>
            </div>
        </div>
    );
};
